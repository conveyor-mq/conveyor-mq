...
[`Task.data`](https://jasrusable.github.io/conveyor-mq/interfaces/task.html#data) is used for storing custom user-data on a task. This should be JSON serializable as it needs to be sent to and from Redis:
